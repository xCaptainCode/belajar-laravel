<x-layout>
  <x-slot:title>{{ $title }}</x-slot:>
    <p class="text-2xl">Ini adalah halaman Contact</p>

    <form class="max-w-md mx-auto">
      <div class="relative z-0 w-full mb-5 group" hidden>
        <trix-editor type="text" name="floating_email" id="floating_email"
          class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
          placeholder=" " required></trix-editor>
      </div>
      ...
      <div class="mb-4">
        ...
        <div id="quill-editor" class="h-64 bg-white border rounded-lg"></div>
